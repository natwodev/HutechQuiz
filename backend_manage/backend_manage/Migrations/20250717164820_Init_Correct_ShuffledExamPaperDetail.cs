    ...
    public partial class Init_Correct_ShuffledExamPaperDetail : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamBatchDetail", x => x.ExamBatchDetailId);
                    table.ForeignKey(
                        name: "FK_ExamBatchDetail_ExamBatches_ExamBatchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamSessions_ExamBatchDetail_ExamBatchDetailId",
                        column: x => x.ExamBatchDetailId,
                        principalTable: "ExamBatchDetail",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamRoom", x => x.ExamRoomId);
                    table.ForeignKey(
                        name: "FK_ExamRoom_ExamSessionSubjects_ExamSessionSubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamRoomLecturerAssignments_ExamRoom_ExamRoomId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentExamSessions_ExamRoom_ExamRoomId",
                        column: x => x.ExamRoomId,
                        principalTable: "ExamRoom",
                        principalColumn: "ExamRoomId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamBatchDetail_ExamBatchId",
                table: "ExamBatchDetail",
                column: "ExamBatchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShuffledExamPaperDetails_ChapterId",
